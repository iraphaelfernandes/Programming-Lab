//NO CODIGO EU FIZ PARA A ENTRADA COM: nome do programa -pprobmutacao -ggeraçoes -frase desejada OU SEM ARGUMENTOS DA LINHA DE COMANDO QUE INICIALIZA A OPCAO DEFAULT.
//NAO ENTENDI COMO FAZER A PARTE DE LER UM TEXTO DE UM ARQUIVO.
//A LISTA GERA O CAMINHO INVERTIDO DA FRASE GERADA ATÉ A META IGNORANDO AS REPETIDAS ESCOLHIDAS. 
